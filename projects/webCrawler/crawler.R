...
dir.create("/Users/ankitchaudhary/rStudio/webCrawler")

#Change working directory
setwd("/Users/ankitchaudhary/rStudio/webCrawler/")
...
#Write the main page
write(main.page, file = "/Users/ankitchaudhary/rStudio/webCrawler/main_page.html")
